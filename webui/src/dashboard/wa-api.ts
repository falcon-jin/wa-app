...
export type FiveSimRegistrationTaskStatus = 'running' | 'stopping' | 'stopped' | 'succeeded' | 'failed';
export type FiveSimRegistrationTaskStats = { target: number; completed: number; success: number; failed: number };
export type FiveSimRegistrationTaskOrder = { id: number; phone?: string; country?: string; operator?: string; product?: string; price?: number; status?: string; sms_count: number };
export type FiveSimRegistrationTask = {
  id: string;
  ...
  active_order?: FiveSimRegistrationTaskOrder;
  last_error?: string;
...
export type FiveSimRegistrationTasksResponse = { tasks: FiveSimRegistrationTask[] };
export type FiveSimRegistrationTaskResponse = { task: FiveSimRegistrationTask; stopped?: boolean };
export type StartFiveSimRegistrationTaskInput = { country: string; operator: string; max_price?: number; success_target: number; integrity_mode?: string };
export type StopFiveSimRegistrationTasksResponse = { stopped_count: number; tasks: FiveSimRegistrationTask[] };
...
export const getFiveSimRegistrationTasks = () => api<FiveSimRegistrationTasksResponse>('/api/wa/debug/5sim/registration-tasks');
export const startFiveSimRegistrationTask = (input: StartFiveSimRegistrationTaskInput) => api<FiveSimRegistrationTaskResponse>('/api/wa/debug/5sim/registration-tasks', { method: 'POST', body: JSON.stringify(input) });
export const stopFiveSimRegistrationTask = (id: string) => api<FiveSimRegistrationTaskResponse>(`/api/wa/debug/5sim/registration-tasks/${encodeURIComponent(id)}/stop`, { method: 'POST' });
export const stopAllFiveSimRegistrationTasks = () => api<StopFiveSimRegistrationTasksResponse>('/api/wa/debug/5sim/registration-tasks/stop', { method: 'POST' });
